...
/**
 * This program recursively finds the sum of the sine values of an array in parallel using Java's
 * ForkJoin Framework. This example is originally from Dan Grossman's A Sophomoric
 * Introduction to Shared-Memory Parallelism and Concurrency, Chapter 3. (Dave Musicant modified it a bit.)
 */
